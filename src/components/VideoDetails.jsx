    ...
    <div className='flex justify-center flex-row h-[calc(100%-56px)] bg-black'>
      <div className="w-full max-w-[1280px] flex flex-col lg:flex-row">
        <div className="flex flex-col lg:w-[calc(100%-350px)] xl:w-[calc(100%-400px)] px-4 py-3 lg:py-6 overflow-y-auto">
          <div className="h-[200px] md:h-[400px] lg:[400px] xl:h-[550px] ml-[-16px] lg:ml-0 mr-[-16px] lg:mr-0">
            <ReactPlayer 
            ...
            <div className="flex text-white mt-4 md:mt-0">
              ...
              <div className="flex items-center justify-center h-11 px-6 rounded-3xl bg-white/[0.15] ml-4">
                ...
                <span>{`${abbreviateNumber(video?.stats?.views, 2)} views`}</span>
                   ...
                   {/* original value lg:w-[350px]  removed - clear-left w-[400px] */}
        <div className="flex flex-col py-6 px-4 overflow-y-auto lg:w-[370px] xl:w-[450px]">
